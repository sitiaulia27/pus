                                    ...
                                    @foreach ($pilihan as $index => $pilih)
                                        @if (
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="<?='pilihan_' . $tanya->id_pertanyaan?>"value="<?=$pilih->bobot?>" required {{isset($options) && $pilih->bobot == $options["pilihan_".$tanya->id_pertanyaan] ? "checked" : ""}}>
                                                {{ $pilih->nama_pilihan }}
                                            </div>
                                        @endif
                                    @endforeach
